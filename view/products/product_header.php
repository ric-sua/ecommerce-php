...
<body ng-app="myApp" ng-controller="customersCtrl">
  ...
  <div class="uk-container uk-container-xlarge">
    <div class="cont">
      <div class="uk-card uk-card-default navbarColor">
        <!-- nav bar contents -->
                    ...
                    if (isset($_SESSION['userID'])) {
                      ...
                      if (count($cart_content) > 0) {
                        foreach ($cart_content as $con) { ?>
                          <li>
                            <div uk-grid>
                              <div class="uk-width-1-3@m"><img ng-src="view/<?= $con['image'] ?>" alt=""></div>
              ...
              <a href="" uk-icon="icon: user; ratio: 1.25">
                ...
                if (isset($_SESSION["userID"])) {
                 ...
                 <h3 > Hi " . $_SESSION['nme'] . " </h3>
                        ...
                        <li><a href='.?action=myorders'>My Orders</a></li>
