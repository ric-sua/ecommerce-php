...
background: -moz-linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(140,140,140,1) 100%);
background: -webkit-linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(140,140,140,1) 100%);
background: linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(140,140,140,1) 100%);
                ...
                if (isset($_SESSION["userID"])) {
                 ...
                 <h3 > Hi " . $_SESSION['nme'] . " </h3>
                  ...
                  echo "<div uk-dropdown='mode: click; pos: bottom-right; boundary: .uk-navbar-container; boundary-align: true;'>
                        <a class='uk-button uk-button-default uk-width-1-1 custom' href='view/account/signin.php'>Login</a>
                        </div>";
                }
                ?>
              </li>
